          ...
          <Container className="container">
            <Row>
              <Col className={styles.privacy}>
                <p>
                  The Publishing Content Group and its related and affiliated companies ( "The Publishing" or "We") respect your privacy and are committed to protecting it through our compliance with the practices described herein. This Privacy Notice (the 'Notice') describes the types of information we may collect from you or that you may provide when you visit our website (the " Website") and The Publishing's practices when collecting, disclosing, maintaining, and using that information. It also describes options you may have regarding collecting, disclosing, and using your personal information when accessing the Website.
                </p>
                <p>
                ...
                <p>
                  Cookies and Other Tracking Technologies: The Publishing and our third-parties, such as our advertising and analytics partners, use cookies and other tracking technologies (e.g., web beacons, device identifiers, and pixels) to provide functionality and to recognize you across different, Products, services and devices.
                </p>
                <p>
                ...
                <ul>
                  <li>To prepare the Website for you.</li>
                  <li>To provide you with information, products, and services.</li>
                  <li>To provide you with information about your account or subscription, including any expiration and renewal notices.</li>
                  <li>To notify you of changes to the Website, products, services we offer or provide though it.</li>
                  <li>To allow you to participate in interactive features on the Website.</li>
                  <li>To send offers or promotions for our products or third-party products, services, or special events.</li>
                  <li>To provide advertising, including advertising based on your activity on the Website or activity on third-party websites.</li>
                  <li>To administer contests, promotions, sweepstakes, or surveys.</li>
                  <li>To optimize or improve our products, services, and operations.</li>
                  <li>To detect, investigate, and help prevent activities that may violate our policies or be illegal.</li>
                  ...
                  <li>To perform statistical, demographic, and marketing analyses of users of the Website and purchasing patterns.</li>
                  <li>In any other way we may describe when you provide personal information.</li>
                ...
                <ul>
                  ...
                  <li>To contractors, service providers, and other third parties, we use to support our business. Our service providers will not use your personally identifiable information for their marketing or other business purposes without your consent.</li>
                  <li>To a buyer or other successor in the event of a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of The Publishing's assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which personal information held by The Publishing about the Website users is among the assets transferred.</li>
                  <li>As permitted by this Notice. For more information, see <a href="/privacy-policy#choices-how-use-disclose-info">Choices About How We Use and Disclose Your Information</a>.</li>
                ...
                <p>
                  If you participate in a contest, survey, sweepstakes, or other promotion sponsored by The Publishing or a third party, such participation serves as your consent to share your information collected in conjunction with the contest, survey, sweepstakes, or promotion, with that co-sponsoring third party. After the information is provided to such third parties, the subsequent use or disclosure of such information is subject to those third parties' privacy policies and practices.
                </p>
                <p>
                ...
                <ul>
                  ...
                  <li>
                    If we believe disclosure is necessary or appropriate to protect the rights, property, or safety of The Publishing, our customers, or others. This includes exchanging information with other companies and organizations for fraud protection and credit risk reduction.
                  </li>
                </ul>
                <p>
                ...
                <ol>
                  <li>By establishing an account with The Publishing or signing up for our email list, you agree to receive communications from us, including promotional emails, and current specials and deals. You may update your communication preferences with us at any time if you would like to alter the frequency, if available, and type of communications you receive from us, or you wish to no longer receive promotional emails from us by updating the communication preferences at the bottom of every email. If you want to receive emails from us but do not wish for us to track the emails we send you, some email services allow you to adjust your display to turn off HTML or disable download of images that should effectively disable our email tracking.</li>
                  <li>You may manage cookies on our Website by modifying your cookie preferences, which is available when you initially access the Website and is also located at the bottom of the Website. You may also turn off all cookies (except necessary cookies) using this method.</li>
                  <li>You may opt-out of your information's collection and use by some advertising networks, as described in the Personalized Advertising section of this Notice above.</li>
                  <li>You may opt-out of tracking analytics data by Google Analytics, one of our customer usage analytics providers, by clicking here.</li>
                  <li>Visitors to our Website can choose not to provide personally identifiable information. In cases where personally identifiable information is needed to register for an account, you may not be able to use our services if you chose not to provide the necessary personally identifiable information.</li>
                </ol>
                <p>
